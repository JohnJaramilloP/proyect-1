...
const columns = [
  ...
  // { id: "area", label: "Area (Civil, Familia, Comercial, Laboral, Penal", minWidth: 200 },
  ...
  // { id: "estudiante que recepciona", label: "Estudiante que recepcionó", minWidth: 150 },
  ...
  // { id: "lugar atencion", label: "Lugar de Atención", minWidth: 100 },
  // { id: "calidad", label: "Calidad (E/A)", minWidth: 100 },
  // { id: "fecha citacion", label: "Fecha de Citación de Parte de Usuario", minWidth: 200 },
  // { id: "participacion individual", label: "Participación Individual", minWidth: 100 },
  // { id: "asesor", label: "Asesor", minWidth: 100 },
  // { id: "representacion terceros", label: "Realizó Representación de Terceros", minWidth: 200 },
  ...
  // { id: "estudiante que recibe", label: "Estudiante que Recibe el Caso", minWidth: 150 },
